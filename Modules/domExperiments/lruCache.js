...
function lruCacheApp() {
  ...
  function loadUtil() {
    const lruCacheTab = addNewTab(null, null, "LRU Cache");
    const lruCacheSection = addNewSection(null, null);
    lruCacheSection.innerHTML = `<h3>LRU Cache</h3>
      <input id="search-input" type="text" placeholder="enter the text" />
      <button id="submit-btn">Get data</button>
